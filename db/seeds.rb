...
test1 = Test.create(title:'Ruby base', level: 0, category_id: category1.id)
test2 = Test.create(title:'Ruby advanced', level: 1, category_id: category1.id)
test3 = Test.create(title:'RoR base', level: 1, category_id: category3.id)
test4 = Test.create(title:'RoR advanced', level: 2, category_id: category3.id)
test5 = Test.create(title:'HTML base', level: 0, category_id: category2.id)
test6 = Test.create(title:'HTML advanced', level: 2, category_id: category2.id)
test7 = Test.create(title:'CSS base', level: 1, category_id: category2.id)
test8 = Test.create(title:'CSS advanced', level: 3, category_id: category2.id)
