...
test4 = Test.create!(title:'RoR advanced', level: 2, category_id: category3.id, user_id: user2.id)
...
test8 = Test.create!(title:'CSS advanced', level: 3, category_id: category2.id, user_id: user2.id)
...
question1 = Question.create!(body: 'Why Ruby?', topic: 'Ruby', test_id: test1.id)
